...
datasets = [ '/Users/alinejad/Desktop/SFU/SNMT-Prediction/Datasets/wmt16_en_de/newstest2015.tok.bpe.32000.en',
...
def perplexity(n_samples, probs):
    off = 1e-8
    return numpy.exp(-1*numpy.mean(numpy.log(probs)+off))
...
def train_lstm(
    ...
    saveto='lstm_model_wmt_de.npz',  # The best model will be saved there
